  ...
  return (
    <div className="container-shell flex min-h-[70vh] items-center justify-center py-20">
      <div className="max-w-2xl rounded-[2.8rem] bg-white p-8 text-center shadow-soft md:p-14">
        ...
        <p className="eyebrow mt-7 text-turquoise-dark">Поръчка {order}</p><h1 className="mt-3 text-4xl font-black md:text-6xl">Благодарим ви!</h1><p className="mx-auto mt-5 max-w-lg font-semibold leading-8 text-ink/60">Поръчката е приета и скоро ще подготвим пакета. Можете да следите статуса й от своя профил.</p>
